    ...
    <header className='bg-gray-900 fixed top-0 left-0 w-full z-50'>
      ...
      >
        <div className='flex lg:flex-1'>
          ...
          >
            <span className='sr-only'>BodyWiki</span>
            <img
              src='/favicon.png'
              alt='BodyWiki logo'
        ...
        {/* <PopoverGroup className='hidden lg:flex lg:gap-x-12'>   /// Comentado para remover o menu dropdown temporariamente ///
        ...
        <DialogPanel className='fixed inset-y-0 right-0 z-50 w-full overflow-y-auto bg-white p-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10'>
          <div className='flex items-center justify-between'>
            <a href='#' className='-m-1.5 p-1.5'>
              <p className='text-sm/6 font-semibold text-green-400'>BodyWiki</p>
              <img
                alt=''
